...
//:Parcelable {
//    constructor(parcel: Long) : this( parcel.readLong() , parcel.readString() , parcel.readString() , parcel.readString() , parcel.readString() , parcel.readArray(RecipeModel::class.java.classLoader) as Array<InstructionModel> ,
